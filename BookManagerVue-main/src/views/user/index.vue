<template>
  <div class="app-container">
    ...
    <div class="filter-container" style="margin-bottom: 15px">
      <!-- 用戶名輸入 -->
      <el-input v-model="queryParam.username" placeholder="用戶名" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
      <!-- 一些按鈕 -->
    ...
    <el-dialog :title="formTitle" :visible.sync="dialogFormVisible" width="30%">
      ...
      <el-form ref="ruleForm" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="用戶密碼" prop="userpassword">
          <el-input v-model="form.userpassword"/>
        </el-form-item>

        <el-form-item label="身份" prop="isadmin">
          <el-radio v-model="form.isadmin" :label="1">管理員</el-radio>
          <el-radio v-model="form.isadmin" :label="0">讀者</el-radio>
        </el-form-item>
      </el-form>
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <el-tag v-if="scope.row.isadmin === 1" type="success">管理員</el-tag>
          <el-tag v-else type="warning">讀者</el-tag>
        </template>
      </el-table-column>
      <el-table-column
        fixed="right"
